...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency "hyper-component", "1.0.0.lap21"
  s.add_runtime_dependency "hyperloop-config", "1.0.0.lap21"
  s.add_development_dependency "hyper-spec", "1.0.0.lap21"
